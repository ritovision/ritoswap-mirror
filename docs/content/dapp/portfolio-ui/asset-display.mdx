...
<div style={{ width: '100%', height: 720, margin: '2rem 0' }}>
  <iframe
    src="/storybook/index.html?path=/story/portfolio-assets-assetdisplay--erc-20&nav=0"
    width="100%"
    height="100%"
...
<div style={{ width: '100%', height: 720, margin: '2rem 0' }}>
  <iframe
    src="/storybook/index.html?path=/story/portfolio-assets-assetdisplay--erc-721-playground&nav=0"
    width="100%"
    height="100%"
    style={{ border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px' }}
...
<div style={{ width: '100%', height: 720, margin: '2rem 0' }}>
  <iframe
    src="/storybook/index.html?path=/story/portfolio-assets-assetdisplay--erc-1155-playground&nav=0"
    width="100%"
    height="100%"
    style={{ border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px' }}
